...
class AuthRepositoryImpl @Inject constructor(
    ...
    override suspend fun loginWithGoogle(context: Context) =
        authService.loginWithGoogle(context)

    override suspend fun loginWithApple(context: Context) =
    ...
    override suspend fun revokeToken() {
        preferences.userCredentials()?.refreshToken?.let {
            authService.revokeToken(it)
        }
    }
}
